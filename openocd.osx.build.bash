...
if [[ ! -d OpenOCD ]] ;
then
	git clone git://github.com/etherkit/OpenOCD.git -b arduino
fi
...
then
	CC=o32-clang CFLAGS="-w -O2 $CFLAGS" CXXFLAGS="-w -O2 $CXXFLAGS" LDFLAGS="$LDFLAGS" ../OpenOCD/configure \
		--prefix=$PREFIX \
...
CFLAGS=-static nice -n 10 make -j $MAKE_JOBS
